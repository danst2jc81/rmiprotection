...
<?php echo form_open('SystemUser/processEditSystemUser',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
	<?php
							...
							<div class = "row">
								<div class = "col-md-6">
									<div class="form-group">
										...
										<?php 
											echo form_dropdown('user_group_id', $systemusergroup, set_value('user_group_id', $systemuser['user_group_id']), 'id="user_group_id", class="form-control select2me"');
										?>
							...
							<div class = "row">
								<div class = "col-md-6">
									<div class="form-group form-md-line-input">
										...
										<input type="text" class="form-control" name="username" id="username" value="<?php echo set_value('username', $systemuser['username']);?>"/>
								...
								<div class = "col-md-6">
									<div class="form-group form-md-line-input">
										...
										<input type="password" class="form-control" name="password" id="password" value="<?php echo set_value('password',$systemuser['password']);?>"/>
