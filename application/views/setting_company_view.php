							...
							<div class="col-md-6">
									<div class="form-group">
										...
										*
										...
										<input type="text" class="form-control" name="company_name" id="company_name" onChange="warningname(company_name);" placeholder="IGN" value="<?php echo set_value('company_name',$result['company_name']);?>"/>
									</div>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="company_home_phone1" id="company_home_phone1" onChange="warningphone1(this.value);" placeholder="Surakarta" value="<?php echo set_value('company_home_phone1',$result['company_home_phone1']);?>"/>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="company_home_phone2" id="company_home_phone2" onChange="warningphone2(this.value);" placeholder="Indonesia" value="<?php echo set_value('company_home_phone2',$result['company_home_phone2']);?>"/>
							</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="company_fax_number" id="company_fax_number" onChange="warningpostal(this.value);" placeholder="57784" value="<?php echo set_value('company_fax_number',$result['company_fax_number']);?>"/>
							</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
						...
						<!--	<div class="row">	
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									echo form_dropdown_search('default_setting_stock', $setting_stock, set_value('default_setting_stock',$data['default_setting_stock']),'id="default_setting_stock"');?>
								</div>
							</div>
							</div>
							<div class="row">	
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									// $minimal_stock_warning_type = array(
										...
										// '1' =>'Per Warehouse',
									// );
									// echo form_dropdown_search('minimal_stock_warning_type', $minimal_stock_warning_type, set_value('minimal_stock_warning_type',$data['minimal_stock_warning_type']),'id="minimal_stock_warning_type"');?>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
