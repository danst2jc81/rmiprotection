...
<?php echo form_open('SystemUserGroup/processEditSystemUserGroup',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
	<?php
		...
		echo form_hidden('old_user_group_name', $systemusergroup['user_group_name']);
	?>
						...
						<div class = "row">
							<div class = "col-md-12">
								<div class="form-group form-md-line-input">
									...
									<input type="text" class="form-control" name="user_group_name" id="user_group_name" value="<?php echo set_value('user_group_name',$systemusergroup['user_group_name']);?>"/>

									<input type="hidden" class="form-control" name="user_group_id" id="user_group_id" value="<?php echo set_value('user_group_id',$systemusergroup['user_group_id']);?>"/>
								</div>
							</div>	
						</div>
